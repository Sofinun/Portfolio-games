...
export const nav: Nav = {
    ...
    items: [
        { label: 'Inicio', href: '/', target: '_self' },// target 为 '_blank' 打开新链接
        { label: 'Proyectos', href: '/project', target: '_self' },
        { label: 'Sobre mí', href: '/about', target: '_self' },
        { label: 'Blog', href: '/blog', target: '_self' },
    ],
};

// Footer
export const footerText = `© ${new Date().getFullYear()} Sofía. All Rights Reserved.`
...
export const homeTdk: SeoTdk = {
	title: 'Portfolio de Sofía - Diseñador y desarrollador creativo',
	description: 'Mostrar algunos de los proyectos de Sofía, diseñador y desarrollador creativo.',
	keywords: 'Sofía, diseñador, portfolio, blog'
}
// SEO TDK 博客
export const blogTdk: SeoTdk = {
	title: 'Blog de Sofía',
	description: 'Notas e ideas personales de Sofía sobre diseño, desarrollo y creatividad.',
	keywords: 'Sofía, blog, diseño, desarrollo'
}
// SEO TDK 关于
export const aboutTdk: SeoTdk = {
	title: 'Acerca de Sofía - Diseñador creativo',
	description: 'Presentación personal de Sofía, diseñador y desarrollador creativo.',
	keywords: 'Sofía, acerca de, diseño, desarrollo'
}
// SEO TDK  项目
export const projectTdk: SeoTdk = {
	title: 'Proyectos de Sofía',
	description: 'Una selección de proyectos de diseño y desarrollo realizados por Sofía.',
	keywords: 'Sofía, proyectos, portfolio'
}
// SEO TDK 404
export const notFoundTdk: SeoTdk = {
	title: '404 Not Found - Aquí no hay nada.',
	description: '404 Not Found - Aquí no hay nada.',
	keywords: '404 Not Found, aquí no hay nada'
}

// Social platforms name: nombre  url: enlace icon: svg icon
export const socialLinks = [
	{
		name: 'Github',
		url: 'https://github.com/Sofinun',
	...
	{
  name: 'LinkedIn',
  url: 'https://www.linkedin.com/in/sofiaagudelo/',
  icon: `<svg class="ic-linkedin icon" width="1792" height="1792" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path fill="#666666" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8A53.79 53.79 0 0 1 53.79 0a53.79 53.79 0 0 1 53.79 53.8c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.7-48.3 87.88-48.3 94 0 111.3 61.9 111.3 142.3V448z"/></svg>`
	},
	{
  name: 'Instagram',
  url: 'https://www.instagram.com/thesoag/',
  icon: `<svg class="ic-instagram icon" width="1792" height="1792" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path fill="#666666" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.3 0-74.7-33.4-74.7-74.7s33.4-74.7 74.7-74.7 74.7 33.4 74.7 74.7-33.4 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.9-26.9 26.9s-26.9-12-26.9-26.9 12-26.9 26.9-26.9 26.9 12 26.9 26.9zM398.8 80c-17.8-17.8-41.5-27.5-66.7-27.5H115.9C63.5 52.5 21 95 21 147.4v216.2C21 416 63.5 458.5 115.9 458.5h216.2c52.4 0 94.9-42.5 94.9-94.9V147.4c0-25.2-9.8-48.9-28.2-67.4zM387 363.6c0 30.2-24.6 54.8-54.8 54.8H115.9c-30.2 0-54.8-24.6-54.8-54.8V147.4c0-30.2 24.6-54.8 54.8-54.8h216.2c30.2 0 54.8 24.6 54.8 54.8v216.2z"/></svg>`
	},

	{
	   name: 'Behance',
	   url: 'https://www.behance.net/sofiaagudelo5',
...
export const pageDescription: PageDescription = {
	index: 'Soy diseñadora gráfica y artista 2D enfocada en videojuegos, especializada en ilustración, diseño de personajes, sprites, backgrounds y contenido para redes sociales, combinando creatividad y soluciones visuales para proyectos digitales.',
	project: 'Una selección de algunos de mis proyectos.',
	about: 'Enfocado en producto, branding, diseño UI y desarrollo visual.',
	blog: 'Mis notas e ideas personales; espero que te resulten útiles.',
}
...
export const filterItems: FilterItem[] = [
	{ content: "💎 Recomendado", dataGroup: "recommend" },
	{ content: "Web", dataGroup: "web" },
	{ content: "UI", dataGroup: "ui" },
	{ content: "3D", dataGroup: "3d" },
	{ content: "Fotografía", dataGroup: "photography" },
